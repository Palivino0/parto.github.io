<div class="row">
    ...
    <div class="col-md-3">
        <?php
          $listeGarconsInscrits = getGarconList("inscris");
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover">
                                ...
                                <tbody> 
                                    ...
                                    $liste = getGarconList("inscris"); // Fetch
                                    foreach ($liste as $key => $inscris) {?>
                                        <tr>
                                            ...
                                            <td style="text-align: center;">
                                              <a href="edit.php?page=All&id_inscris=<?= $inscris['id_inscris'] ?>" class="btn btn-info">
                                               <span class="glyphicon glyphicon-edit" aria-hidden="true"></span>
                                              </a>
                                              <a href="delete.php?page=All&id_inscris=<?= $inscris['id_inscris'] ?>" class="btn btn-danger">
                                               <span class="glyphicon glyphicon-trash" aria-hidden="true" style="color: wihte;"></span>
                                              </a>
                                            </td>
                                        </tr>
                                    <?php } ?>
